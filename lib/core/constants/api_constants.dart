class ApiConstants {
  ...
  // static const String baseUrl = 'https://excellencedigital.ci/api/v1'; // Production
  ...
  static const String clientFormationsDisponibles = '/client/formations/disponibles';
  static const String clientInscrireFormation = '/client/formations/{formation}/inscrire';
  static const String clientRessources = '/client/formations/{formation}/ressources';
  static const String clientQcms = '/client/qcms';
  static const String clientDemarrerQcm = '/client/qcms/{qcm}/demarrer';
  static const String clientSoumettreQcm = '/client/qcms/{qcm}/soumettre';
  static const String clientResultatSession = '/client/sessions/{session}/resultat';
